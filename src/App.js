            ...
            <footer className="p-4 mt-5">
                ...
                <span className="font-merriweather-sans text-lg sm:text-center">
                   ...
                   • Source on <a href="https://github.com/aktech/ufo.camera" className="hover:underline text-gray-700">GitHub</a>
                    ...
                    <p>
                        <a href="https://nuforc.org/file-a-report/" className="hover:underline text-gray-700">Report a UFO Sighting</a>
                    </p>
        ...
        return (
            <div
                ...
                <div className="md:text-right lg:text-right xl:text-right">
                    <a href="#_" className="relative inline-block text-lg group show-me-ufo-button" onClick={onClickShowUfo}>
                        <span
                ...
                <div className="md:text-left lg:text-left xl:left">
                    <a   href={`https://twitter.com/intent/tweet?text=Checkout this UFO 👉 ${encodeURIComponent(window.location.href)}`}
                        ...
                        <span className="relative font-merriweather-sans">Share on Twitter</span>
                    </a>
                </div>
